...
import (
	...
	"github.com/stanlyliao/selenium/sauce"
)
...
func TestDocker(t *testing.T) {
	...
	// passed to go test.
	cmd := exec.Command("docker", "run", fmt.Sprintf("--volume=%s:/code", pathToMount), "--workdir=/code/src/github.com/stanlyliao/selenium", "go-selenium", "testing/docker-test.sh")
	if testing.Verbose() {
